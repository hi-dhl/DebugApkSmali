.class public Lcom/miui/support/app/ListFragment;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/miui/support/app/ListFragment;->b:Z

    iput-boolean v0, p0, Lcom/miui/support/app/ListFragment;->c:Z
...
.method public a()Landroid/content/Context;
    ...
    iget-object v0, p0, Lcom/miui/support/app/ListFragment;->a:Lcom/miui/support/internal/app/FragmentDelegate;
...
.method public a(ILandroid/view/View;Landroid/view/Menu;)V
    ...
    iget-boolean v0, p0, Lcom/miui/support/app/ListFragment;->b:Z

    if-eqz v0, :cond_0

    iget-boolean v0, p0, Lcom/miui/support/app/ListFragment;->c:Z

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Lcom/miui/support/app/ListFragment;->isHidden()Z

    move-result v0

    if-nez v0, :cond_0

    invoke-virtual {p0}, Lcom/miui/support/app/ListFragment;->isAdded()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0, p3}, Lcom/miui/support/app/ListFragment;->onPrepareOptionsMenu(Landroid/view/Menu;)V
...
.method public a(ILandroid/view/Menu;)Z
    ...
    iget-boolean v1, p0, Lcom/miui/support/app/ListFragment;->b:Z

    if-eqz v1, :cond_0

    iget-boolean v1, p0, Lcom/miui/support/app/ListFragment;->c:Z
    ...
    invoke-virtual {p0, p2}, Lcom/miui/support/app/ListFragment;->a(Landroid/view/Menu;)Z
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/miui/support/app/ListFragment;->a:Lcom/miui/support/internal/app/FragmentDelegate;
...
.method public final onHiddenChanged(Z)V
    ...
    :goto_0
    invoke-virtual {p0, v0}, Lcom/miui/support/app/ListFragment;->a(Z)V
...
.method public setHasOptionsMenu(Z)V
    ...
    iput-boolean p1, p0, Lcom/miui/support/app/ListFragment;->b:Z
...
.method public setMenuVisibility(Z)V
    ...
    iput-boolean p1, p0, Lcom/miui/support/app/ListFragment;->c:Z
